...
export const REGISTER_DEFINITIONS: RegisterDefinition[] = [
  ...
  { id: 0x33, name: "VEL_PID_LIM", encoding: "f32", tooltip: "Velocity PID output limit" },
  { id: 0x34, name: "VEL_PID_RAMP", encoding: "f32", tooltip: "Velocity PID ramp" },
  { id: 0x35, name: "VEL_LPF_T", encoding: "f32", tooltip: "Velocity low-pass filter time constant" },
  ...
  { id: 0x53, name: "DRIVER_VOLTAGE_LIMIT", encoding: "f32", tooltip: "Driver voltage limit" },
  { id: 0x54, name: "PWM_FREQUENCY", encoding: "u32", tooltip: "PWM frequency (Hz)" },
  { id: 0x55, name: "DRIVER_VOLTAGE_PSU", encoding: "f32", tooltip: "PSU voltage for driver" },
